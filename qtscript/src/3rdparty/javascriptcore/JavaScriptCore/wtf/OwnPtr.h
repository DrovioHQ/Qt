...
namespace WTF {
    ...
    public:
        ...
        OwnPtr(std::unique_ptr<ValueType>& uniquePtr) : m_ptr(uniquePtr.release()) { }
        ...
        void adopt(std::unique_ptr<ValueType>& uniquePtr) { ASSERT(!uniquePtr.get() || m_ptr != uniquePtr.get()); deleteOwnedPtr(m_ptr); m_ptr = uniquePtr.release(); }
